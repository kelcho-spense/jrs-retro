...
function SecurityPage() {
    ...
    const securityFeatures = [
        ...
        },
        {
            icon: Key,
            title: 'Passkeys',
            description: 'Use biometric authentication or security keys for passwordless login.',
            status: 'disabled',
            action: 'Set Up',
        },
        {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8">
            ...
            >
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-lg bg-cyan-500/10 dark:bg-cyan-400/10 flex items-center justify-center">
                        <Key className="w-5 h-5 text-cyan-500 dark:text-cyan-400" />
                    </div>
                    <div>
                ...
                {error && (
                    <div className="mb-6 p-4 bg-red-500/10 dark:bg-red-400/10 border border-red-500/20 dark:border-red-400/20 rounded-lg flex items-center gap-3">
                ...
                {isSaved && (
                    <div className="mb-6 p-4 bg-green-500/10 dark:bg-green-400/10 border border-green-500/20 dark:border-green-400/20 rounded-lg flex items-center gap-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <Input
                                ...
                                className="bg-background border-border focus:border-cyan-500 dark:focus:border-cyan-400 pr-10"
                            />
                            <button
                                type="button"
                    ...
                    {securityFeatures.map((feature, index) => (
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div
                                    className={`w-10 h-10 rounded-lg flex items-center justify-center ${feature.status === 'enabled'
                                        ? 'bg-green-500/10 dark:bg-green-400/10'
                                        : 'bg-muted'
                                        }`}
                                >
                                    <feature.icon
                                        className={`w-5 h-5 ${feature.status === 'enabled'
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span
                                            className={`text-xs px-2 py-0.5 rounded-full ${feature.status === 'enabled'
            ...
            {/* Login Activity */}
            <div className="bg-card rounded-xl border border-border p-6">
                <h2 className="text-lg font-semibold text-foreground mb-4">Recent Login Activity</h2>
